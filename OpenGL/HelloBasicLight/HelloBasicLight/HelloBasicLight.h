...
#include "shader.h"
#include "camera.h"
class HelloBasicLight : public QOpenGLWidget
{
    Q_OBJECT

public:
    HelloBasicLight(QWidget *parent = Q_NULLPTR);
public:
...
private:
	...
	QVector3D lightColor = QVector3D(1.0f, 1.0f, 1.0f);//物体的本身反射率
};
